...
public interface IFriendshipRepository
{
    ...
    Task<PagedList<FriendDto>> GetUserFriendsAsync(Guid userId, ElementParams elementParams);
    Task<PagedList<FriendRequestDto>> GetPendingRequestsAsync(Guid userId, ElementParams elementParams);
